...
namespace itaxcix\Shared\Validators\useCases\InfractionStatus;

use itaxcix\Core\Interfaces\infraction\InfractionStatusRepositoryInterface;

class InfractionStatusValidator
{
    ...
    public function validateCreate(array $data): array
    {
        ...
        if (empty($data['name'])) {
            ...
            $errors['name'] = 'Ya existe un estado de infracción con este nombre';
        }
    ...
    public function validateId(int $id): array
    {
        ...
        if ($id <= 0) {
            ...
            $errors['id'] = 'El estado de infracción no existe';
        }
