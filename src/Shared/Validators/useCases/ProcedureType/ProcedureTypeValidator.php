...
namespace itaxcix\Shared\Validators\useCases\ProcedureType;
...
class ProcedureTypeValidator
{
    ...
    public function validateCreate(array $data): array
    {
        ...
        if (empty($data['name'])) {
            ...
            $errors['name'] = 'Ya existe un tipo de trámite con este nombre';
        }
    ...
    public function validateId(int $id): array
    {
        ...
        if ($id <= 0) {
            ...
            $errors['id'] = 'El tipo de trámite no existe';
        }
