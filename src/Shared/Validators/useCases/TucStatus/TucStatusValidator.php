...
namespace itaxcix\Shared\Validators\useCases\TucStatus;

use itaxcix\Core\Interfaces\vehicle\TucStatusRepositoryInterface;

class TucStatusValidator
{
    ...
    public function validateCreate(array $data): array
    {
        ...
        if (empty($data['name'])) {
            ...
            $errors['name'] = 'Ya existe un estado TUC con este nombre';
        }
    ...
    public function validateId(int $id): array
    {
        ...
        if ($id <= 0) {
            ...
            $errors['id'] = 'El estado TUC no existe';
        }
