...
#[OA\Schema(description: "Datos necesarios para crear o actualizar un elemento del centro de ayuda")]
readonly class HelpCenterRequestDTO {
    public function __construct(
        #[OA\Property(description: "ID del elemento (opcional para crear)", example: 1)]
        public ?int $id,
