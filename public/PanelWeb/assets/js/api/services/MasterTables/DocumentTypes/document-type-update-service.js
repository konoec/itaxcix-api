/**
 * Servicio para actualizar tipos de documento
 * Endpoint: PUT /api/v1/admin/document-types/{id}
 */
class DocumentTypeUpdateService {
    constructor() {
        this.baseUrl = 'https://149.130.161.148/api/v1/admin/document-types';
    }
    ...
    async updateDocumentType(id, data) {
        try {
            console.log('🔄 Actualizando tipo de documento:', { id, data });

            // Validar datos de entrada
            const validation = this.validateDocumentTypeData(data);
            ...
            if (result.success) {
                ...
                throw new Error(result.message || 'Error desconocido al actualizar el tipo de documento');
            }
...
window.DocumentTypeUpdateService = new DocumentTypeUpdateService();
window.documentTypeUpdateService = window.DocumentTypeUpdateService;
console.log('✅ DocumentTypeUpdateService cargado y disponible globalmente');
