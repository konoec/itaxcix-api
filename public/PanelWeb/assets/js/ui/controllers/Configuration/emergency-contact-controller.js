/**
 * Controlador para la gestión de contacto de emergencia
...
class EmergencyContactController {
    ...
    async init() {
        ...
        try {
            ...
            console.log('✅ EmergencyContactController inicializado correctamente');
        } catch (error) {
            console.error('❌ Error al inicializar EmergencyContactController:', error);
        }
    }
...
window.EmergencyContactController = EmergencyContactController;
