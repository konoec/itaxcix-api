/**
 * Inicializador específico para la página de Gestión de Modelos de Vehículos
 * Maneja solo los componentes y controladores necesarios para esta página específica
 */
class VehicleModelInitializer {
    static async init() {
        console.log('🚗 Inicializando página de Gestión de Modelos de Vehículos...');
        ...
        if (authChecker.checkAuthentication()) {
            ...
            try {
                ...
                await componentLoader.loadComponent('topbar', '#topbar-container', {
                    pageTitle: window.pageConfig?.pageTitle || { icon: 'fas fa-car', text: 'Gestión de Modelos de Vehículos' }
                });
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        console.log('✅ Modelos de Vehículos inicializado completamente');
                    }, 400);
